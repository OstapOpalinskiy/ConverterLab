package com.opalinskiy.ostap.converterlab.constants;


public class dbConstants {
    public static final String DATABASE_NAME = "converterLab.db";
    ...
    public static final String COLUMN_CHANGE_ASK = "changeAsk";
    public static final String COLUMN_CHANGE_BID = "changeBid";
}
